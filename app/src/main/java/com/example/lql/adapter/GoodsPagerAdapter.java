...
import com.example.lql.fragment.BookCoverFragment;
import com.example.lql.fragment.BookDetailFragment;
import com.example.lql.fragment.BooktRecommendFragment;
import com.example.lql.fragment.BooktpAssessragment;
...
public class GoodsPagerAdapter extends FragmentStatePagerAdapter {
    ...
    public Fragment getItem(int position) {
        if (position == 0) { // 第一页展示书籍封面
            ...
            return new BooktRecommendFragment();
        } else if (position == 3) { // 第二页展示书籍详情
            return new BooktpAssessragment();
        }
        return new BookCoverFragment();
    }
